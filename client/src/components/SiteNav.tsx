...
export function SiteNav() {
  ...
  return (
    <nav
      className="sticky top-0 left-0 right-0 z-50 bg-black/60 backdrop-blur-md border-b border-white/10"
    >
              ...
              <SheetContent side="right" className="w-[280px] sm:w-[320px] bg-background border-border">
                <div className="flex flex-col gap-1 mt-8">
                  ...
                  <Link 
                    ...
                    className="text-[15px] font-semibold text-center bg-white text-black py-3 px-4 rounded-full hover:bg-white/90 transition-colors mt-2"
                  >
                    Book a demo
                  </Link>
                </div>
