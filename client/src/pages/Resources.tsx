        ...
        <div className="cv-container max-w-[1000px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredGuides.slice(0, 3).map((guide) => (
              ...
              >
                <span className="text-xs font-medium px-2 py-1 rounded border border-white/10 bg-white/5 text-cv-muted inline-block mb-3">
                  {guide.category}
                </span>
          ...
          <div className="flex flex-wrap gap-3">
            {categories.map((category) => (
              <Link
                ...
                className="text-sm font-medium px-4 py-2 rounded-full border border-white/10 bg-white/5 text-cv-muted hover:bg-white/10 transition-colors"
              >
                {category}
              </Link>
            ))}
